...
//    void OnGUI()
//    {
//        GUILayout.Label("⚙️  SCORM Export Settings", EditorStyles.boldLabel);
...
//        GUILayout.Space(8);
//        GUILayout.Label("🌐 WebGL Hosting Details", EditorStyles.boldLabel);
...
//        GUI.backgroundColor = new Color(0.22f, 0.55f, 0.95f); // bluish tint
...
//    {
//        // ✅ Ask for build folder like normal WebGL build
...
//        // ✅ 2. Generate dynamic index_scorm.html
//        string htmlPath = Path.Combine(buildFolder, indexScormFile);
//        string iframeSrc = $"{buildURL.TrimEnd('/')}/{buildName}/index.html";
...
//      }} else {{
//        console.log(""Unity instance not found at page load."");
//      }}
//    </script>
//  </body>
//</html>";
...
//        // ✅ 5. Create Content ZIP (excluding SCORM files)
//        Debug.Log("📦 Creating game content zip...");
